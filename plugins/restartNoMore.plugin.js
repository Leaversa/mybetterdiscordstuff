      ...
      switch (typeof (typeof (base = (o = plugin.getSettingsPanel)) === "function" ? base(remove) : void 0)) {
        ...
        case "string":
          return plugin.getSettingsPanel = function(remove) {
            ...
            return ((o != null ? o.apply : void 0) ? (o.apply(plugin, arguments)) + "<br>" : "") + `<button type="button" onclick="restartNoMore.reload('${plugin.constructor.name}')" style="background-color:#ff6262" "border-radius: 5px;">Reload with Restart-No-More</button>`;
          };
      }
    } catch (error) {
      e = error;
